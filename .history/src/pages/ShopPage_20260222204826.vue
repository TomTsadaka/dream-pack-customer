        ...
        <div class="lg:col-span-3">
          ...
          <div class="mb-4">
            <p class="text-gray-600">
              Showing {{ productsStore.pagination?.total || 0 }} products
            </p>
          </div>
          ...
          <!-- Pagination -->
          <Pagination
            v-if="!productsStore.loading && productsStore.filteredProducts.length > 0 && productsStore.pagination"
...
watch(
  ...
  async (newQuery) => {
    ...
    if (page !== productsStore.query.page) {
      productsStore.query.page = page;
    }
    await productsStore.loadProducts();
  }
